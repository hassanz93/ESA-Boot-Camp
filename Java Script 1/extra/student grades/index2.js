var inp = []; var inp0 = []; var average_mark; var final_remark; var numb_crs;
    ...
    for (i=2; i<22; i++)   { 
    document.getElementById('add0' +i).type = 'text' ; }       
    ...
    for (let i = 21; i > (numb_crs+1); i--){                    // depening on the nub_crs for loop the text boxes that will hide
        ...
        document.getElementById("add0" +i).style.display="none"  // remove the text boxes by displaying them as none and hidng them
    ...
    function input_admin() {   // function to input and save data as inp[]
     ...
     for (var i = 1; i <= numb_crs; i++) {                                  // for loop for the number of subjects chosen
        ...
        inp0[i]= document.getElementById("add0" + (i +1)).value;  // insert subjects for each mark 
    ...
    document.getElementById('add0' +i).value = '';  }           // place empty string inside text boxes 
      ...
      function clearFieldsSubjects() {                                       // function to clear the fields inside text boxes
        for (i=1; i<22; i++){
              }           // place empty string inside text boxes 
            const container = document.querySelector('.container');    // clear input boxes for the grades with empty strings
            while (container.lastChild) {                              // take last child element of the parent container
                container.removeChild(container.lastChild);            // remove containers with clear is clicked
                                    }
